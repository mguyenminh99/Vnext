...
namespace Vnext\Region\Model\Import;

use Vnext\Region\Model\Import\ProjectImport\RowValidatorInterface as ValidatorInterface;
use Magento\ImportExport\Model\Import\ErrorProcessing\ProcessingErrorAggregatorInterface;
use Magento\Framework\App\ResourceConnection;
use Vnext\Region\Model\RegionsFactory;
use Vnext\Region\Model\CountryFactory;
use Vnext\Region\Model\CountryCodeFactory;
...
class ProjectImport extends \Magento\ImportExport\Model\Import\Entity\AbstractEntity
{
   ...
   {
        $regions = $this->regionsFactory->create()->getCollection()->addFieldToFilter('default_name', ['eq' => $rowData[self::DEFAULT_NAME]])->getData();
        $code = $this->countryCodeFactory->create()->getCollection()->addFieldToFilter('code', ['eq' => $rowData[self::COUNTRY_ID]])->getData();
        if (!empty($regions)) {
